...
LLM_SETTING_EXTRACTION_MAX_OUTPUT_TOKENS=6000
LLM_SETTING_EXTRACTION_RETRY_MAX_OUTPUT_TOKENS=12000
LLM_WORLD_SETTING_EXTRACTION_MAX_OUTPUT_TOKENS=5000
...
docker compose --env-file .env -f compose.prod.yml exec ai-worker printenv LLM_SETTING_EXTRACTION_MAX_OUTPUT_TOKENS
docker compose --env-file .env -f compose.prod.yml exec ai-worker printenv LLM_SETTING_EXTRACTION_RETRY_MAX_OUTPUT_TOKENS
docker compose --env-file .env -f compose.prod.yml exec ai-worker printenv LLM_WORLD_SETTING_EXTRACTION_MAX_OUTPUT_TOKENS
docker compose --env-file .env -f compose.prod.yml exec ai-worker printenv LLM_WORLD_SETTING_EXTRACTION_RETRY_MAX_OUTPUT_TOKENS
docker compose --env-file .env -f compose.prod.yml exec ai-worker printenv LLM_SUBJECT_RESOLUTION_MAX_OUTPUT_TOKENS
docker compose --env-file .env -f compose.prod.yml exec ai-worker printenv LLM_COMPARISON_MAX_OUTPUT_TOKENS
docker compose --env-file .env -f compose.prod.yml exec ai-worker printenv LLM_PROVIDER_MAX_OUTPUT_TOKENS
