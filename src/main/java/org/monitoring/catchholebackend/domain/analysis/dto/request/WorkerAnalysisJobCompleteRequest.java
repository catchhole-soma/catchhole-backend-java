...
public record WorkerAnalysisJobCompleteRequest(
        ...
        @Schema(description = "구버전 Worker 호환용 입력 토큰 수. Backend 정산에는 사용하지 않음", nullable = true)
        @Min(value = 0, message = "입력 토큰 수는 0 이상이어야 합니다.")
        Integer inputTokenCount,

        @Schema(description = "구버전 Worker 호환용 출력 토큰 수. Backend 정산에는 사용하지 않음", nullable = true)
