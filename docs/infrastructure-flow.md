...
2026-09-11의 백업·삭제 보호 재확인과 RPO 15분·RTO 2시간·자동 백업 7일 유지의 판단 기준은 [RDS 백업·삭제 보호 정책](rds-backup-policy.md)에 기록합니다. 복구 시간은 미실측 목표이며 알림·복원 훈련 완료를 뜻하지 않습니다.
...
- RDS 자동 백업 7일·삭제 보호 활성 재확인 및 [T2 정책·삭제 절차](rds-backup-policy.md) 정리: 실제 복구 성공·소요 시간 검증은 #175
